...
public class ExceptionController {
    ...
    public ResponseEntity<ApiError> handleNotFound(final NotFoundException e) {
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(ApiError.of(HttpStatus.NOT_FOUND, e.getMessage(), List.of(e.getMessage())));
    }
    ...
    public ResponseEntity<ApiError> handleConflict(final ConflictException e) {
        ...
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ApiError.of(HttpStatus.CONFLICT, e.getMessage(), List.of(e.getMessage())));
    }
    ...
    public ResponseEntity<ApiError> handleAccess(final AccessException e) {
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(ApiError.of(HttpStatus.FORBIDDEN, e.getMessage(), List.of(e.getMessage())));
    }
    ...
    public ResponseEntity<ApiError> handleServiceUnavailable(final ServiceUnavailableException e) {
        ...
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
                .body(ApiError.of(HttpStatus.SERVICE_UNAVAILABLE, e.getMessage(), List.of(e.getMessage())));
    }
    ...
    public ResponseEntity<ApiError> handleUnexpected(final Exception e) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(ApiError.of(HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage(), List.of(e.getMessage())));
    }
}